-- Flood Risk Prediction Database Schema (Simplified without PostGIS)
-- PostgreSQL for storage

-- Cities table with coordinates (without PostGIS)
...
DROP TRIGGER IF EXISTS update_weather_daily_updated_at ON weather_daily;
...
('Mumbai', 19.0760, 72.8777, 12440000),
('Chennai', 13.0827, 80.2707, 7046000),
('Kolkata', 22.5726, 88.3639, 4497000),
('Patna', 25.5941, 85.1376, 2094000),
('Guwahati', 26.1445, 91.7362, 967000)
